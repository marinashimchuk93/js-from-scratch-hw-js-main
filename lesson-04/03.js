...
function findCommonElements(array1, array2) {
  ...
  for (let i = 0; i < array1.length; i++) {
    ...
    if (
      includesElement(array2, currentElement) &&
      !includesElement(generalElements, currentElement)
    ) {
      generalElements.push(currentElement);
    }
  }
  return generalElements;
}

const result = findCommonElements([1, 2, 3], [2, 3, 4]);
console.log(result);
